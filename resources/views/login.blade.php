...
<head>
	...
	<title>
        Sales Representative Management | @yield('title')
	</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href=""><b>Sales Representative Management</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <form action="/login" method="post">
                ...
                @if(session()->has('error'))
                    <div class="alert-danger admin-login-error" id="alert-danger">
                        {{ session()->get('error') }}
                    </div>
                    <br>
                @endif
	...
	<!-- AdminLTE App -->
	<script src="{{ asset('js/common/icheck.min.js') }}"></script>
